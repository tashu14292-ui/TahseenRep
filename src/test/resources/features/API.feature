...
@AddPlace
  Scenario: Add place
    Given User requests for "Add Place" using the below data:
      ...
      | Frontline house | French-IN | 10, Anuj test automation  | 50       | (+91) 983 893 3937  | http://google.com | -38.383494 | 33.427362 | shoe park,shop |
...
@GetPlace
  ...
  And Response field "address" should be "10, Anuj test automation"
...
@PutPlace
  ...
  Given User requests for "Put Place" using the below data:
      | address            | place id            |
      | 15, Anuj test automation, India | Already stored from get scenario into apiResponseData/place_id.text |
  ...
  And Response field "address" should be "15, Anuj test automation, India"
